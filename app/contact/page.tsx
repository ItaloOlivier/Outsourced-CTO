  ...
  return (
    <>
            ...
            <div>
              ...
              <div style={{ marginBottom: '30px' }}>
                ...
                <p style={{ color: '#828282', lineHeight: 1.8, paddingLeft: '30px' }}>
                  The Campus<br />
                  Corner of Main &amp; Sloane Street<br />
              ...
              <div style={{ marginBottom: '30px' }}>
                <h3 style={{ fontSize: '18px', marginBottom: '10px', color: '#303030' }}>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="#25D366" stroke="none" style={{ marginRight: '10px', verticalAlign: 'middle' }}>
      ...
      <section style={{ height: '400px', background: '#f7f7f7' }}>
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3584.0088018465!2d28.0252!3d-26.0589!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1e9573b1b1b1b1b1%3A0x0!2sThe%20Campus%2C%20Bryanston!5e0!3m2!1sen!2sza!4v1629876543210!5m2!1sen!2sza"
          width="100%"
          height="100%"
          style={{ border: 0 }}
          allowFullScreen
